...
id_post (TINYINT, PK)  posts numbers (1–8)
location VARCHAR(255) -> locations name

#### **occupations**
Main entity representing the occupation of each post.

id_occupations (INT, PK) 
post_id (FK -> posts.id_post) 
...
id_weapon (INT, PK)
occupation_id (FK -> occupations.id_occupations)
weapon VARCHAR(150) weapon name
